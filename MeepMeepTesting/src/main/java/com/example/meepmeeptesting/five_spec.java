...
public class five_spec {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(-23.5, 61.5, Math.toRadians(270)))
                ...
                .splineToLinearHeading(new Pose2d(-54,55, Math.toRadians(270)), Math.toRadians(270))
                ...
                //.splineToLinearHeading(new Pose2d(-61,55, Math.toRadians(270)), Math.toRadians(270))
                                .lineToY(55)
                ////////////////////////////////////////////////////////////////////////////////////////
