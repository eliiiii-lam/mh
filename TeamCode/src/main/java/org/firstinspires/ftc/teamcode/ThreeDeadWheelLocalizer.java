...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 9768.59995167511; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -10965.286191714178; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -12871.275527051588; // x position of the perpendicular encoder (in tick units)
    }
