...
@Disabled
@TeleOp(name = "Base Heavy", group = "TELE")

public class BaseHeavy extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.y){
                outmainPiv.setPosition(0.99);
                outmainPiv2.setPosition(0.97);
                outY.setPosition(0.5);
                outRot.setPosition(0.95);
                sleep(700);
                outClaw.setPosition(0.5);
            ...
            if (gamepad1.b){
                outClaw.setPosition(0.96);
                outmainPiv.setPosition(0.80);
                outmainPiv2.setPosition(0.78);
                outY.setPosition(0.5);
                outRot.setPosition(0.95);
                sleep(700);
